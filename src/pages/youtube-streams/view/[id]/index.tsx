...
import { getYoutubeStreamById } from 'apiSdk/youtube-streams';
...
function YoutubeStreamViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Youtube Stream Detail View
          </Text>
          {hasAccess('youtube_stream', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/youtube-streams/edit/${data?.id}`} passHref legacyBehavior>
              <Button
